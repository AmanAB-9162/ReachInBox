...
export function LoginForm() {
  ...
  return (
    <Card className="w-full max-w-md shadow-lg bg-gray-900 border-gray-800 text-gray-100">
      <CardHeader className="space-y-2 text-center">
        ...
        <CardDescription className="text-gray-400">Sign in to your Reachinbox account</CardDescription>
      </CardHeader>
      <CardContent>
        {error && (
          <div className="bg-red-900/30 text-red-400 p-3 rounded-md mb-4 text-sm border border-red-800">{error}</div>
        )}
